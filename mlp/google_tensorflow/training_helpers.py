...
def inference(examples, num_features, num_classes, hidden1_units, hidden2_units):
    ...
    with tf.name_scope('hidden1') as scope:
        ...
        biases = tf.Variable(tf.zeros([hidden1_units]),
                             name='biases')
        hidden1 = tf.nn.relu(tf.matmul(examples, weights) + biases)
    # Hidden 2
