...
object Dependency {
  ...
  object aws {
    private val awsSdkVersion = "1.9.3"
    private val s3 = "com.amazonaws" % "aws-java-sdk-s3" % awsSdkVersion intransitive()
    private val core = "com.amazonaws" % "aws-java-sdk-core" % awsSdkVersion intransitive()
    private val jacksonDatabind = "com.fasterxml.jackson.core" % "jackson-databind" % "2.5.3"
  ...
  object dl4j {
    ...
    private val jacksonDF           = "com.fasterxml.jackson.dataformat"  % "jackson-dataformat-yaml" % "2.5.3" intransitive()
