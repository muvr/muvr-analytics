...
public class CNNMnistExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(mnistIter.hasNext()) {
            ...
            INDArray featureMatrix = trainInput.getFeatureMatrix();
            INDArray labels = trainInput.getLabels();

            System.out.println("cols: " + featureMatrix.columns() + ", rows: " + featureMatrix.rows());
