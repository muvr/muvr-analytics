...
spark-submit --class io.muvr.em.ModelTrainerMain --driver-memory 4G --driver-class-path target/scala-2.10/em-assembly-1.0.0-SNAPSHOT.jar target/scala-2.10/em-assembly-1.0.0-SNAPSHOT.jar $PARAMS
